...
<div class="content">
	<?=$this->load->view("includes/_bread")?>
            <div class="workplace">
			<div class="row-fluid">
                <?=$this->load->view('_bank_navigation')?>
                </div>            
                                ...
                                <div class="block-fluid ucard">
                                        <div class="info">                                                                
                                            <ul class="rows">
                                                ...
                                                <li>
                                                    <div class="title title1">Responsable of the Bank:</div>
                                                    <div class="text text1"><?php echo $query['res_person_en'].'<br>'.$query['res_person_ar'];?>&nbsp;</div>
                                                </li>
    											<li>
												...
												<li>
                                                    <div class="title title1">Bank establish_date</div>
                                                    <div class="text text1">
													<?php echo $query['establish_date'];?>&nbsp;</div>
                                                </li>
												<li>
                                                    <div class="title title1">Bank Ref</div>
                                                    <div class="text text1">
													<?php echo $query['bnk_ref'];?>&nbsp;</div>
                                                </li>
                       

												<li>
                                                    <div class="title title1">رأس المال</div>
                                                    <div class="text text1">
													<?php echo $query['bnk_capital'];?>&nbsp;
													</div>
                                                </li>
												<li>
                                                    <div class="title title1">رقم الإستمارة</div>
                                                    <div class="text text1">
													<?php echo $query['list_number'];?>&nbsp;
													</div>
                                                </li>
												<li>
                                                    <div class="title title1">المرجع</div>
                                                    <div class="text text1">
													<?php echo $query['bnk_ref'];?>&nbsp;
													</div>
                                                </li>
												<li>
                                                    <div class="title title1">Interview Person</div>
                                                    <div class="text text1">
													<?php echo $query['res_person_ar'];?>&nbsp;<br>
													<?php echo $query['res_person_en'];?>&nbsp;
													</div>
                                                </li>
												<li>
                                                    <div class="title title1">Is Advertised</div>
                                                    <div class="text text1">
													<?php echo $query['is_adv'];?>&nbsp;
													</div>
                                                </li>
												<li>
                                                    <div class="title title1">Copy Reservation</div>
                                                    <div class="text text1">
													<?php echo $query['copy_res'];?>&nbsp;
													</div>
                                                </li>
                                ...
                                <div class="block-fluid ucard">
                                        <div class="info">                                                                
                                            <ul class="rows">
                                                ...
                                                <li>
                                                    <div class="title title1">Kadaa:</div>
