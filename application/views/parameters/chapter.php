                ...
                <div class="block-fluid">                        
                    ...
                    <div class="row-form clearfix">
						...
						<?php 
								...
								{
									if($section->id!=0)
									$array_section[$section->id]=$section->label_en.' ('.$section->label_ar.')';	
								}
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
						...
						foreach($query as $row){?>
                            <tr>
								...
								<?=$row->label_ar?></td>
                                <td><?=$row->section_en.' ('.$row->section_ar.')'?></td>
                            ...
                            <div id="<?=$row->id?>Modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <?php echo form_open_multipart('parameters/items/chapter_edit',array('id'=>'validation'.$row->id));
                                    ...
                                    <div class="row-fluid">
                                        <div class="block-fluid">
                                             <div class="row-form clearfix">
                                                ...
                                                <div class="span2"><input type="text" name="cha_nbr" value="<?=$row->cha_nbr?>" required="required" /></div>
                                            </div> 
                                            <div class="row-form clearfix">
   											...
   											<div class="row-form clearfix">
												...
												echo form_dropdown('sector',$array_sector,$row->sector_id,$class_sect2);
							?></div>
                                            </div> 
                                            <div class="row-form clearfix">
                                                <div class="span3">Section (القسم) *:</div>
                                                <div class="span9"><div id="datasection2">
												<?php 
												$sections2=$this->Item->GetSectionsBySectorId('online',$row->sector_id);
												//$array_section2[0]='All ';
												foreach($sections2 as $section2)
												{
													if($section2->id!=0)
													$array_section2[$section2->id]=$section2->label_en.' ('.$section2->label_ar.')';	
												}
															
												echo form_dropdown('section',$array_section2,$row->section_id);
											?></div></div>
                                            </div>       
                                          	<div class="row-form clearfix">
