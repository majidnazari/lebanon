            ...
            <?php if($msg!=''){ ?>
                ...
                <div class="head clearfix">
                    ...
                    <h1><?=$subtitle?></h1>
                     ...
                     <?=_show_add_pop('#CreateModal','Add New',$p_add_licensesources)?> 
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
                                ...
                                <tr>
                                    ...
                                    <td><?=$createdBy?></td>
                                    <td><?php 
                                            echo _show_delete('parameters/delete/id/'.$row->id.'/p/licensesources/',$p_delete_licensesources);
                                            echo _show_edit_pop('#'.$row->id.'Modal',$p_edit_licensesources);
                                    ?>                                        
                                    </td>                                    
                            </tr>
                            <?php if($p_edit_licensesources){ ?>
                            <div id="<?=$row->id?>Modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-header">
                                        ...
                                        <h3 id="myModalLabel">Edit License Sources</h3>
                                    </div>  
                                    <?php 
									
									echo form_open_multipart('parameters/edit_license_sources',array('id'=>'validation'.$row->id));
...
<?php if($p_add_licensesources){ ?>
<div id="CreateModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="myModalLabel">Add New License Sources</h3>
    </div>  
    <?php echo form_open_multipart('parameters/create_license_sources',array('id'=>'validation'));?>      
    <div class="row-fluid">
        <div class="block-fluid">
            <div class="row-form clearfix">
                <div class="span3">Title in english *:</div>
