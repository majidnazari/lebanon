...
<body>
	<div class="container">
    	<div class="header"><img src="<?=base_url()?>img/importer-header.jpg" width="100%" /></div>
        ...
        <table class="table-view" style="width:920px !important; margin-top:10px !important">
            ...
            <?php
               ...
               <tr>
                    	<td colspan="5">
                            <div class="data-box english">Other : <?=$query['activity_other_en']?></div>
                            <div class="data-box arabic">آخرى : <?=$query['activity_other_ar']?></div>                    
                        </td>
                    </tr> 
               <?php } ?>         
            <tr class="trhead">
