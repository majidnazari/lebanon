                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
						...
						foreach($query as $row){
                            ...
                            <tr>
                                ...
                                <td><?=$row->action?></td>
                                <td><?=anchor('logs/insurance-details/'.$row->id,@$array_data->name_ar.'<br>'.@$array_data->name_en,array('target'=>'_blank'))?></td>
                                
                                <td><?=$row->create_time?></td>
                                <td>
								<?php 
										echo _show_delete('logs/delete/id/'.$row->id.'/p/insurance/',$p_delete_insurance);
										if($p_restore_insurance)
										echo anchor('logs/restore/id/'.$row->id.'/p/insurance','<i class="isb-left_circle"></i>',array('title'=>'Restore'));
									?>                                        
                                </td>                                    
                            </tr>
