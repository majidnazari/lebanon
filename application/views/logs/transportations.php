                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center" width="21%">Name</th>
						...
						foreach($query as $row){
                            ...
                            <tr>
                                ...
                                <td><?=$row->action?></td>
                                <td><?=anchor('logs/transportation-details/'.$row->id,@$array_data->name_ar.'<br>'.@$array_data->name_en,array('target'=>'_blank'))?></td>
                                
                                <td><?=$row->create_time?></td>
                                <td>
								<?php 
										echo _show_delete('logs/delete/id/'.$row->id.'/p/transportation/',$p_delete_transportation);
										if($p_restore_transportation)
										echo anchor('logs/restore/id/'.$row->id.'/p/transportation','<i class="isb-left_circle"></i>',array('title'=>'Restore'));
									?>                                        
                                </td>                                    
                            </tr>
