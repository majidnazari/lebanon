...
<body>
	<div class="container">
    	...
    	<div class="clear"></div>
        <h3 class="d-num">رقم الاستمارة : <?=$logs['id']?></h3>
        <table class="table-view" style="width:920px !important; margin-top:10px !important">
            ...
            <tr>
				...
				if($query['maritime']==1)
				 ...
				 echo '<div class="span5">'.$checkedMaritime_en.' Maritime<br>'.$checkedlocal_en.' Locally<br>'.$query['member_local_en'].'</div>
					<div class="span5">'.$checkedAirline_en.' Airline<br>'.$checkedoverseas_en.' Overseas<br>'.$query['member_overseas_en'].'</div>';?></td>
                    <td colspan="3" style="border-left:none !important; text-align:right">
                    	...
                    	<?php 
						echo '<div class="span6 label-ar"> بحرية  '.$checkedMaritime_ar.'<br> في الخارج '.$checkedoverseas_ar.'<br>'.$query['member_overseas_ar'].'</div>
            ...
            <tr>
				...
				if($query['service_landline']==1)
				 ...
				 echo '<div class="span57">'.$s_landline_en.' Landline</div><div class="span57">'.$s_maritime_en.' Maritime</div><div class="span57">'.$s_airline_en.'Airline</div>';?></td>
                    <td colspan="3" style="border-left:none !important; text-align:right">
                    	<h2 class="arabic" style="margin-left:15px !important;">  خدمات النقل :</h2>
                    	<?php 
						echo '<div class="span67 label-ar"> برية  '.$s_landline_ar.'</div><div class="span67 label-ar"> بحرية '.$s_maritime_ar.'</div><div class="span67 label-ar"> جوية'.$s_airline_ar.'</div>';?>
                    </td>
            </tr>
