...
<div class="row-form clearfix">
    ...
    <div class="row-form clearfix">                    
        ...
        <div class="span1"><?php 
            ...
            echo  form_checkbox('show_online', 1, $checkedonline); ?>
        </div>
        ...
        <div class="span1"><?php
            ...
            echo date('Y'). form_checkbox('acc', 1, $checkedacc); ?>
        </div>
        ...
        <div class="span1"><?php 
            ...
            echo date('Y').' '. form_checkbox('task_status', 1, $checkedtask_status); ?>
        </div>
    </div> 
    <div class="row-form clearfix">
