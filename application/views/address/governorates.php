            ...
            <?php if($msg!=''){ ?>
                ...
                <div class="head clearfix">
                    ...
                    <h1><?=$subtitle?></h1>
                     ...
                     <?=_show_add_pop('#CreateModal','Add New',$p_add_governorate)?> 
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
                                ...
                                <tr>
                                    ...
                                    <td><?=$createdBy?></td>
                                    <td><?php 
                                         echo _show_delete('addresses/delete/id/'.$row->id.'/p/governorate/',$p_delete_governorate);
                                         echo _show_edit_pop('#'.$row->id.'Modal',$p_edit_governorate);
                            ...
                            <div id="<?=$row->id?>Modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-header">
                                        ...
                                        <h3 id="myModalLabel">Edit Sector</h3>
                                    </div>  
                                    <?php 
									
									echo form_open_multipart('addresses/edit_governorates',array('id'=>'validation'.$row->id));
...
<?php if($p_add_governorate){ ?>
<div id="CreateModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="myModalLabel">Add New Governorate</h3>
    </div>  
    <?php echo form_open_multipart('addresses/create_governorates',array('id'=>'validation'));?>      
    <div class="row-fluid">
        <div class="block-fluid">
            <div class="row-form clearfix">
                <div class="span3">Title in english *:</div>
