...
$(document).ready(function(){
    ...
    if($("#chart-3").length > 0){
		...
		?>
       	data[<?=$i?>] = { label: "<?=$count->company?>", data: Math.floor(<?=$count->schedule_count?>*100)+1 };
		<?php 
		$i++;
		} ?>	        
   ...
   <div class="row-fluid">                
        <div class="span6">
            ...
            <div class="row-form clearfix"> 
            		<div class="span">Companies<br><?php 
								$array_countries['']='Please Select a Company';
								...
								echo form_dropdown('client',$array_clients,$client);
							?></div>                      
