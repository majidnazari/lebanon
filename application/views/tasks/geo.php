                ...
                <div class="block-fluid table-sorting clearfix">
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
						...
						foreach($query as $row){
                            $sql=$this->Task->GetGeoNotTasked($row->governorate_id,$row->district_id,$row->area_id,date('Y'),0,0);
                            ?>
                            <tr>
                                ...
                                <td style="text-align:center"><?=anchor('tasks/view/pending/'.$row->area_id,'View ('.$row->pending_count.')')?></td>
                                <td style="text-align:center"><?=anchor('tasks/view/done/'.$row->area_id,'View ('.$row->done_count.')')?></td>
                            </tr>
