...
<body>
	<div class="container">
    	...
    	<div class="clear"></div>
        <h3 style="text-align: center !important;"><?=@$query['results'][0]->district_ar.'<br>Kazaa - '.ucfirst($status)?></h3>
	...
	$phone=explode('-',$row->phone);
        	...
        	<tr>
                    ...
                    <td style="text-align:center"><?=$is_adv?></td>
                    <td style="text-align:center"><?=$copy_res?></td>
                    <td></td>
                </tr>
           <?php 
		   $i++;
