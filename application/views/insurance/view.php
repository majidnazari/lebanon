                    ...
                    <td colspan="5">
                        <table style="width:100%">
                            <?php foreach($executives as $executive) {?>
								...
								for($i=0;$i<3-count($executives);$i++){
								 echo '<tr>
                                    <td>&nbsp;</td>
                                    <td style="text-align:right; width:50%">&nbsp;</td>
                                </tr>';
                    ...
                    <td colspan="5">
                        <div class="box">
                            <table dir="rtl" width="100%"  style="border:none !important" cellpadding="10px">
                                <tr>
                                    <td width="70%" colspan="3" style="border:none !important; font-size:18px !important"><strong>- اسم الشخص الذي تمت معه  المقابلة في  المؤسسة : </strong><?=$query['rep_person_en'].'&nbsp;&nbsp;&nbsp;<span style="float:left1">'.$query['rep_person_en'].'</span>';?></td>
