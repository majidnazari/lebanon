...
<table>
    ...
    <tr>
        ...
        <td class="yellow">  رقم التسجيل في وزارة الاقتصاد والتجارة :</td>
        <td class="data-box english"><?= $query['ins_number']; ?>&nbsp;</td>
    </tr>
    <tr>
        <td class="yellow"> رقم الانتساب لجمعية شركات الضمان في لبنان :</td>
        <td class="data-box arabic"><?= $query['ins_ecoo_no']; ?>&nbsp;</td>
    </tr>

    <tr>
        <td class="yellow">General Manager :</td>
        <td class="data-box arabic"><?= $query['chairman_en']; ?>&nbsp;</td>
    </tr>
    <tr>
        <td class="yellow"> المدير العام : </td>
        <td class="data-box arabic"><?= $query['chairman_ar']; ?>&nbsp;</td>
    </tr>
    <tr class="trhead">
    ...
    ?>
    <tr>
        <td class="yellow">Executive Management</td>
        <td class="yellow">الادارة التنفيذية</td>
    </tr>
    <?php if (count($executives)) {
    ...
    <tr>
        <td class="yellow">Classes of Business Transacted</td>
        <td class="yellow"> أوجه النشاط التي تمارسها الشركة</td>
    </tr>
    ...
    ?>
    <tr>
        <td class="yellow">Other - Specify:</td>
        <td class="data-box english"><?= $query['activity_other_en']; ?></td>
    </tr>
    <tr>
        <td class="yellow"> نشاطات أخرى - حدد : </td>
        <td class="data-box english"><?= $query['activity_other_ar']; ?></td>
    </tr>
    <tr class="trhead">
