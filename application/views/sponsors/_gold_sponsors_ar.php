...
.col1{
        ...
        .list-left li{
            ...
            <?php for($i=1;$i<=9;$i++){
                ...
                if(@$sponsors[$i]->id!='')
                {
                    echo '<a href="#Modal'.$i.'" data-toggle="modal"><div class="row2 element-ar"><img src="http://www.lebanon-industry.com/'.$sponsors[$i]->logo.'" class="photo" /></div></a>';
                }
                else{
                    echo '<a href="#Modal'.$i.'" data-toggle="modal"><div class="row2 element-ar"></div></a>';
                }
                 $sp['query']=$sponsors[$i];
