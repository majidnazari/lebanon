            ...
            <?php if($msg!=''){ ?>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
                                ...
                                <tr>
                                    ...
                                    <td><?=$createdBy?></td>
                                    <td><?php 
                                            echo _show_delete('items/delete/id/'.$row->id.'/p/sector/',$p_delete_sector);
                                            echo _show_edit_pop('#'.$row->id.'Modal',$p_edit_sector);
                                    ?>                                        
                                    </td>                                    
                            </tr>
                            <?php if($p_edit_sector){ ?>
...
<div id="CreateModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="myModalLabel">Add New Sector</h3>
    </div>  
    <?php echo form_open_multipart('items/create_sector',array('id'=>'validation'));?>      
    <div class="row-fluid">
        <div class="block-fluid">
            <div class="row-form clearfix">
                <div class="span3">Title in english *:</div>
