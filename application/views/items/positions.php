                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
                        ...
                        <?php foreach($query as $row){?>
                            <tr>
                                ...
                                <td><?php 
										echo _show_delete('parameters/items/delete/id/'.$row->id.'/p/position/st/'.$st,$p_delete);
                            ...
                            <div id="<?=$row->id?>Modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-header">
                                        ...
                                        <h3 id="myModalLabel">Edit Governorate</h3>
                                    </div>  
                                    <?php echo form_open_multipart('parameters/items/position_edit',array('id'=>'validation'.$row->id));
...
<div id="CreateModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <?php echo form_open_multipart('parameters/items/position_create',array('id'=>'validation'));
										  echo form_hidden('st',$st);
									?>      
                                    <div class="row-fluid">
                                        <div class="block-fluid">
