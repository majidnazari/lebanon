            ...
            <?php if($msg!=''){ ?>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
                                ...
                                <tr>
                                    ...
                                    <?=$row->label_ar?></td>
                                    <td><?=$row->section_ar?></td>
                                    <td><?php 
											echo $createdBy;
                                            echo _show_delete('items/delete/id/'.$row->id.'/p/chapter/',$p_delete_chapter);
                                            echo _show_edit_pop('#'.$row->id.'Modal',$p_edit_chapter);
                                    ?>                                        
                                    </td>                                    
                            </tr>
                            <?php if($p_edit_chapter){ ?>
                            <div id="<?=$row->id?>Modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-header">
                                        ...
                                        <h3 id="myModalLabel">Edit Chapter</h3>
                                    </div>  
                                    <?php 
									
									echo form_open_multipart('items/edit_chapter',array('id'=>'validation'.$row->id));
                                    ...
                                    <div class="row-fluid">
                                        <div class="block-fluid">
                                            <div class="row-form clearfix">
                                                ...
                                                <div class="span9"><input type="text" name="cha_nbr" value="<?=$row->cha_nbr?>" required="required" /></div>
                                                </div>
                                              <div class="row-form clearfix">
                                            ...
                                            <div class="row-form clearfix">
                                                ...
                                                <div class="span9">
                                                <?php 
													$array_section[0]='Select Section ';
													...
													echo form_dropdown('section',$array_section,$row->section_id,'class="select2"');
...
<div id="CreateModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <?php echo form_open_multipart('items/create_chapter',array('id'=>'validation'));?>      
    <div class="row-fluid">
        <div class="block-fluid">
        <div class="row-form clearfix">
            <div class="span3">Code *:</div>
            <div class="span9"><input type="text" name="cha_nbr" required="required" /></div>
            </div>
            <div class="row-form clearfix">
                <div class="span3">Title in english *:</div>
            ...
            <div class="row-form clearfix">
                ...
                <?php 
                    ...
                    echo form_dropdown('section',$array_section,'','class="select2"');
