            ...
            <?php if($msg!=''){ ?>
                ...
                <div class="head clearfix">
                    ...
                    <h1><?=$subtitle?></h1>
                     ...
                     <?=_show_add_pop('#CreateModal','Add New',$p_add_section)?> 
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
                                ...
                                <tr>
                                	<td><?=$row->scn_nbr?></td>
                                    <td><?=$row->label_en?></td>
                                    <td align="right" style="text-align:right !important; font-size:13px !important">
                                    <?=$row->label_ar?></td>
                                    <td style="font-size:13px !important"><?=$row->sector_ar?></td>
                                    <td><?php 
											echo $createdBy;
                                            echo _show_delete('items/delete/id/'.$row->id.'/p/section/',$p_delete_section);
                                            echo _show_edit_pop('#'.$row->id.'Modal',$p_edit_section);
                                    ?>                                        
                                    </td>                                    
                            </tr>
                            <?php if($p_edit_section){ ?>
                            <div id="<?=$row->id?>Modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									...
									echo form_open_multipart('items/edit_section',array('id'=>'validation'.$row->id));
                                    ...
                                    <div class="row-fluid">
                                        <div class="block-fluid">
                                        	<div class="row-form clearfix">
                                                ...
                                                <div class="span9"><input type="text" name="scn_nbr" value="<?=$row->scn_nbr?>" required="required" /></div>
                                                </div>
                                            <div class="row-form clearfix">
                                            ...
                                            <div class="row-form clearfix">
                                                <div class="span3">Sector *:</div>
                                                <div class="span9">
                                                <?php 
													$array_sector[0]='Select Sector ';
													...
													echo form_dropdown('sector',$array_sector,$row->sector_id,'class="select2"');
...
<div id="CreateModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <?php echo form_open_multipart('items/create_section',array('id'=>'validation'));?>      
    <div class="row-fluid">
        <div class="block-fluid">
        <div class="row-form clearfix">
            <div class="span3">Code *:</div>
            <div class="span9"><input type="text" name="scn_nbr" required="required" /></div>
            </div>
            <div class="row-form clearfix">
                <div class="span3">Title in english *:</div>
            ...
            <div class="row-form clearfix">
                ...
                <?php 
                    ...
                    echo form_dropdown('sector',$array_sector,'','class="select2"');
