        ...
        <div class="row-fluid">
            <div class="span12">
               <div class="head clearfix">
                    ...
                    <h1><?=$subtitle?></h1>
                   <?=anchor('companies/district_export','<h2 style="float: right !important">Export To Excel</h2>')?>
                </div>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
                                ...
                                <tr>
                                    ...
                                    <td><?=$percentage?> %</td>
                                    <td><?=anchor('companies?id=&ministry_id=&name=&activity=&phone=&gov='.$row->governorate_id.'&district_id='.$row->district_id.'&area_id=&status=all&search=Search','View Companies',array('target'=>'_blank'))?></td>
                                </tr>
                                  <?php  } ?>
                                </tbody>
                            </table>
