                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center" width="6%">Show Items</th>
						...
						foreach($query as $row){
									...
									if(count($type)>0){
										...
										*/
										...
										echo 'Yes';
											...
											if($row->show_items==1){
									            $show_status=0;
									            $show_label='Hide Items';
										}
										else{
										 $show_status=1;
										 $show_label='Show Items';
											}
										?></td>
                            ...
                            if(count($task)>0){
                                    ...
                                    ?></td>
                                     <td><?=anchor('companies/show_items/'.$row->id.'/'.$show_status,$show_label);?></td>
                                <td nowrap="nowrap">
