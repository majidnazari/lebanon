                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">مصدر رخصة الانشاء</th>
                                <th style="text-align:center">مصدر الرخصة الاستثمار</th>
						...
						foreach($query as $row){
                            ...
                            <tr>
                                ...
                                {
                                    echo anchor('companies/save/'.$row->id,'<span class="isb-plus"></span>');
                                }
                                elseif(count($companies)==1 and $companies[0]->ministry_id==$row->id)
                                {
                                    echo anchor('companies/update_ministry/'.$row->id.'/cid/'.$companies[0]->id,'Update & Delete');
                                }
                                else{
                                    echo anchor('companies/report_ministry/'.$row->id,'Add To Report',array('class'=>'btn'));
                                    echo anchor('companies/ministry_company_delete/' . $row->id, 'Delete',array('class'=>'btn'));
                                }
                        ...
                        <tfoot>
                        	<tr>
                                <td colspan="12">Total : <?=$total_row?><div class="dataTables_paginate paging_full_numbers"><?=$links?></div></td></tr>
                        </tfoot>
                    </table>
