            ...
            <div class="span12">
                ...
                <div class="block-fluid">
                    <div class="row-form clearfix">
                        ...
                        <div class="span4"><?php echo form_dropdown('category', array('general'=>'General','direct'=>'Direct'), @$query['category'],'id="category"'); ?><?=form_error('category'); ?></div>
                    </div>
                    <div class="row-form clearfix">
