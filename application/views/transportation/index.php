...
function change_status(id,status)
	{
		...
		$.ajax({
			url: "<?php echo base_url();?>transportations/change_status",
			type: "post",
...
function getdistrict(gov_id,district_id)
	{
		...
		$.ajax({
			url: "<?php echo base_url();?>transportations/GetDistricts",
			type: "post",
    ...
    function getarea(district_id)
    {
        $("#area").html("loading ... ");
        $.ajax({
            url: "<?php echo base_url();?>transportations/GetArea",
            type: "post",
            data: "id="+district_id,
            success: function(result){
                $("#area").html(result);
    ...
    function printall()
        {
            ...
            document.getElementById("form_id").action = "<?=base_url().'transportations/printall'?>";
       ...
       <div class="row-fluid">
            <div class="span12">
                ...
                <div class="block-fluid">                        
                    ...
                    <div class="row-form clearfix">
                        <div class="span12" style="text-align: center"><input type="submit" name="search" value="Search" class="btn">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
						...
						foreach($query as $row){
                            ...
                            <tr>
                                ...
                                <td><?=anchor('transportations/details/'.$row->id,$row->name_ar.'<br>'.$row->name_en)?></td>
                                <td><?php 
								...
								<?php 
										echo anchor('transportations/view/'.$row->id,'<span class="isb-print"></span>',array('target'=>'_blank'));
									//	echo _show_delete('transportations/items/delete/id/'.$row->id.'/p/chapter/st/'.$st,$p_delete);
										echo _show_edit('transportations/edit/'.$row->id,$p_edit);
