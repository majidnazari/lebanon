<?php
/********************General Info**********************/
$array_name_ar=array('id'=>'name_ar','name'=>'name_ar','value'=>$name_ar,'class'=>'label-ar','tabindex'=>1,'required'=>'required');
$array_name_en=array('id'=>'name_en','name'=>'name_en','value'=>$name_en,'tabindex'=>2,'required'=>'required');


/*********************Address*************************/
$array_street_ar=array('id'=>'street_ar','name'=>'street_ar','value'=>$street_ar,'class'=>'label-ar');
$array_street_en=array('id'=>'street_en','name'=>'street_en','value'=>$street_en);

$array_bldg_ar=array('id'=>'bldg_ar','name'=>'bldg_ar','value'=>$bldg_ar,'class'=>'label-ar');
...
$array_pobox_ar=array('id'=>'pobox_ar','name'=>'pobox_ar','value'=>$pobox_ar,'class'=>'label-ar');
$array_pobox_en=array('id'=>'pobox_en','name'=>'pobox_en','value'=>$pobox_en);

$array_beside_ar=array('id'=>'beside_ar','name'=>'beside_ar','value'=>$beside_ar,'class'=>'label-ar');
    ...
    <div class="workplace">
        <div class="page-header">
            <h1><?=$subtitle?>
                ...
                &nbsp;
                <?=anchor('banks/branches/'.$id,'Cancel',array('class'=>'btn btn-large','style'=>'float:right !important; margin-right:10px'))?>
            </h1>
        </div> 
        ...
        <div class="span9">
				...
				<div class="block-fluid">
                    ...
                    <div class="row-form clearfix">   
                		...
                		&nbsp;<?=anchor('banks/branches/'.$id,'Cancel',array('class'=>'btn btn-large','style'=>''))?></center>      
                    </div>                                       
                    </div>            
