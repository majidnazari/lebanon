        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="head clearfix">
                    ...
                    <h1><?=$subtitle?></h1>
					 <?php 
				echo anchor('reports/company_banks/en','<h3 style="float:right !important; color:#FFF !important"> - English  </h3>');
			   echo anchor('reports/export_cbanks?bank='.$bank.'&lang=ar','<h3 style="float:right !important; color:#FFF !important">Export To Excel</h3>');
                ...
                <div class="block-fluid table-sorting clearfix">
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
						...
						foreach($banks as $item){
							...
							$query=$this->Report->GetCompanyByBankId($item->id,'ar');
