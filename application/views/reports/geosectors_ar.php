...
$(document).ready(function(){
	...
	?>
		data[<?=$i?>] = { label: "<?=$district->label_ar?>", data: Math.floor(<?=$nbr?>*100)+1 };
	<?php 
		$i++;
	} ?>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="head clearfix">
                    ...
                    <h1><?=$subtitle?></h1>
					 <?php 
				echo anchor('reports/geosectors/?lang=en&gov='.$gov.'&search=Search','<h3 style="float:right !important; color:#FFF !important"> - English  </h3>');
			   echo anchor('reports/ExportGeoSectors/'.$gov.'/ar','<h3 style="float:right !important; color:#FFF !important">Export All To Excel</h3>');
        ...
        ?>                                  
                ...
                <div class="block-fluid table-sorting clearfix">
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
						...
						foreach($districts as $district){
							$total=0;
						echo '<tr><td nowrap="nowrap">'.$district->label_ar.'</td>';	
