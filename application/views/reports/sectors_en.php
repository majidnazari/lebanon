...
$(document).ready(function(){
	...
	?>
		data[<?=$i?>] = { label: "<?=$gover->label_en?>", data: Math.floor(<?=$nbr?>*100)+1 };
	<?php 
		$i++;
	} ?>
            ...
            <div class="span12">
                ...
                <div class="block-fluid">                        
                    <div class="row-form clearfix">
                        <div class="span3">Mohafazat<br /><?php 
								$array_gov[0]='All ';
								foreach($governorates as $gover)
								{
									if($gover->id!=0)
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="head clearfix">
                    ...
                    <h1><?=$subtitle?></h1>
					 <?php 
				echo anchor('reports/sectors/ar','<h3 style="float:right !important; color:#FFF !important"> - Arabic  </h3>');
			   echo anchor('reports/ExportSectors/en','<h3 style="float:right !important; color:#FFF !important">Export All To Excel</h3>');
        ...
        ?>                                  
                ...
                <div class="block-fluid table-sorting clearfix">
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
						...
						foreach($governorates as $gover){
							$total=0;
						echo '<tr><td nowrap="nowrap">'.$gover->label_en.'</td>';	
