        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="head clearfix">
                    ...
                    <h1><?=$subtitle?></h1>
					 <?php 
				echo anchor('reports/insurance/en','<h3 style="float:right !important; color:#FFF !important"> - English  </h3>');
			   echo anchor('reports/export_insurance/ar','<h3 style="float:right !important; color:#FFF !important">Export To Excel</h3>');
        ?>                                  
                </div>  
