        ...
        <table class="table-view" style="width:920px !important" style="margin-top:10px !important">
            <tr>
            	<td colspan="5">
                    ...
                    <div class="data-box english"><?=form_input(array('name'=>'name_en','id'=>'name_en'));?>&nbsp;</div>
                    <div class="label arabic"> اسم المؤسسة:</div>
                    <div class="data-box arabic"><?=form_input(array('name'=>'name_ar','id'=>'name_ar'));?>&nbsp;</div>                    
                </td>
            </tr>
            <tr>
            	<td colspan="5">
                	<div class="label english">Owner / Owners of The Co. :</div>
                    <div class="data-box english"><?=form_input(array('name'=>'owner_name_en','id'=>'owner_name_en'));?>&nbsp;</div>
                    <div class="label arabic"> صاحب / اصحاب الشركة: :</div>
                    <div class="data-box arabic"><?=form_input(array('name'=>'owner_name','id'=>'owner_name'))?>&nbsp;</div>                    
                </td>
            </tr>
            <tr>
            	<td colspan="5">
                	<div class="label english">Name of The Authorized to Sign :</div>
                    <div class="data-box english"><?=form_input(array('name'=>'auth_person_en','id'=>'auth_person_en'))?>&nbsp;</div>
                    <div class="label arabic"> اسم المفوض بالتوقيع  :</div>
                    <div class="data-box arabic"><?=form_input(array('name'=>'auth_person_ar','id'=>'auth_person_ar'))?>&nbsp;</div>                    
                </td>
            </tr>
            <?php 
				if(count(@$license)>0){
           ...
           <tr>
			...
			?>
				<td colspan="5">
                	<div class="label english">Assemblies of Economical, Technical or Local Order - Specify : </div>
                    <div class="data-box english"><?=$economical_assembly_en;?></div>
                    <div class="label arabic">  اتحادات مهنية اقليمية او دولية - حدد:  </div>
           ...
           <td colspan="5">
			...
			<tr>
            	<td colspan="5">
                    ...
                    <div class="data-box english"><?php if(count($banks)){
             ...
             <tr class="trhead">
            	<td colspan="5" class="thead">
                    <div class="thead english">Electric Power : </div>
                    <div class="thead arabic">استعمال الطاقة : </div>
                </td>
            </tr>  
            ...
            <tr>
            	<td colspan="5">
                    ...
                    <div class="data-box english"><?php if(count($powers)){
										foreach($powers as $power){ 
										echo $power->fuel;
										}
									}
