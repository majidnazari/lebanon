...
$(document).ready(function(){
   ...
   // TOOLTIPS
        ...
        // WYSIWIG HTML EDITOR    
         ...
         { 
            $("#tSortable").dataTable({"iDisplayLength": 25, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": true }, null, null, null, null]});
         ...
         if($("#tSortable_salesman").length > 0)
         { 
            $("#tSortable_salesman").dataTable({"iDisplayLength": 25, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": true }, null, null, null, null,null]});
